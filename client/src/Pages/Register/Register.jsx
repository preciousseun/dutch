    ...
    <>
        ...
        {/* <div className='container mt-4 mb-5'>
          <Link to='/' className='link'>
            ...
            <div className='regBox shadow-md'>
              <div className='regImg'>
                <div className='imgBox'>
                  <div className='imgBoxOverlay'></div>
                </div>
              </div>
              <div className='regForm'>
                <div className='formBox'>
                  <h3 className='regWelcome mb-4 text-center'>JOIN US TODAY!!!</h3>
                  <form className='regForm mb-4'>
                    ...
                    <input type="country" placeholder='Country' className='mb-3'/>
                    <input type="password" placeholder='Password' className='mb-3'/>
                    <input type="password" placeholder='Confirm Password'/>
                  </form>
                  <button className='regisBtn mb-3'>
